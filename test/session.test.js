...
describe("Test de session", () => {
    it("[POST] /api/session/register este endpoint debe registrar un nuevo usuario", async () => {
        const newUser = {
    ...
    it("[GET] /api/session/current  endpoint para mostrar la información del usuario solo un usuario", async () => {
